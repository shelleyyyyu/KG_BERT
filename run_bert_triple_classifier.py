...
def main():
    ...
    tokenizer = BertTokenizer.from_pretrained(args.bert_model, do_lower_case=args.do_lower_case, cache_dir='models')
    ...
    model = BertForSequenceClassification.from_pretrained(args.bert_model,
              cache_dir=cache_dir,
              num_labels=num_labels, cache_dir='models')
    if args.fp16:
        model.half()
    model.to(device)
    if args.local_rank != -1:
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        model = BertForSequenceClassification.from_pretrained(args.output_dir, num_labels=num_labels, cache_dir='models')
        tokenizer = BertTokenizer.from_pretrained(args.output_dir, do_lower_case=args.do_lower_case, cache_dir='models')
    else:
        model = BertForSequenceClassification.from_pretrained(args.bert_model, num_labels=num_labels, cache_dir='models')
    model.to(device)
